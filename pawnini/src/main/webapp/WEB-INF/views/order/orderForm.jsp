...
function finalCheck() {
	...
	var ord_card_info2 = $("#cardno1").val()+"-"+$("#cardno2").val()+"-"+$("#cardno3").val()+"-"+$("#cardno4").val();
...
<br><br><br>
	...
	<table border="1">
		...
		<!-- 주문정보 입력 -->
 <form role="orderForm" method="post" autocomplete="off" action="insertOrder.do">
  ...
  <!-- 결제정보  -->
  	결제정보
		...
		최종결제금액 &nbsp;&nbsp;<span id="ord_total"></span>
  		...
  		&nbsp;(가용 적립금 : <span style="color:crimson; font-weight:bold"> <fmt:formatNumber pattern="###,###,###" value="${member.member_mileage}" /> 원</span>
  		<input type="checkbox" name="chkAll" id="chkAll" onclick="useAllMileage('${member.member_mileage}')">전부 사용하기)
